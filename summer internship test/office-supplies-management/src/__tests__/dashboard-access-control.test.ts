...
describe('Dashboard Access Control Tests', () => {
  ...
  describe('Admin Dashboard Access', () => {
    it('should allow admin access to admin dashboard', async () => {
      ...
      expect(DASHBOARD_ACCESS.ADMIN.allowedRoles).toContain('ADMIN')
      expect(DASHBOARD_ACCESS.ADMIN.allowedRoles).not.toContain('MANAGER')
      expect(DASHBOARD_ACCESS.ADMIN.allowedRoles).not.toContain('EMPLOYEE')
    })
    ...
    it('should allow admin access to system dashboard', async () => {
      ...
      expect(DASHBOARD_ACCESS.SYSTEM.allowedRoles).toContain('ADMIN')
      expect(DASHBOARD_ACCESS.SYSTEM.allowedRoles).not.toContain('MANAGER')
      expect(DASHBOARD_ACCESS.SYSTEM.allowedRoles).not.toContain('EMPLOYEE')
    })
