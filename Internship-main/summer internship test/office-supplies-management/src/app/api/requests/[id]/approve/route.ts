...
export async function POST(
  ...
  try {
    ...
    // If no specific approval found and user is ADMIN, allow them to approve any pending request
    if (!currentApproval && userRole === 'ADMIN') {
      ...
      if (anyPendingApproval) {
        // Create or reassign the approval to the admin
        ...
        // No pending approvals, create a new one for the admin
